...
int main(){
    ...
    //Scientific notation
    //What we have seen so far in terms of floating point typesm is
    //fixed notation. There is another notation, scientific that is
    //handy if you have really huge numbers or small numbers to represent
